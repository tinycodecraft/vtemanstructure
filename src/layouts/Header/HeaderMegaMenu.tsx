      ...
      <Header height={60} px="md">
        <Group position="apart" sx={{ height: '100%' }}>
          ...
          <Group sx={{ height: '100%' }} spacing={0} className={classes.hiddenMobile}>
            ...
            <HoverCard width={600} position="bottom" radius="md" shadow="md" withinPortal onClose={openclosehover} onOpen={openclosehover}>
              <HoverCard.Target>
                <a href="#" className={classes.link}>
                  <Center inline>
                    ...
                    <IconChevronDown size={16} color={theme.fn.primaryColor()} className={clsx(openHovered ? 'active': '')} />
                  </Center>
                </a>
              </HoverCard.Target>
